...
1. Добавьте в каталог `artifacts` целевой сервис: [app-replan-delivery.jar](app-replan-delivery.jar) для первой задачи, [app-ibank.jar](app-ibank.jar) для второй задачи — см. раздел Настройка CI. **Файлы SUT берём из данного репозитория.**   
