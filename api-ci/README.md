# Домашнее задание к занятию «2. Тестирование API, CI»
...
Можете воспользоваться сервисами https://extendsclass.com/jsonpath-tester.html или https://jsonpath.com/ для быстрой проверки выражений. Описание синтаксиса
https://testerslittlehelper.wordpress.com/2019/01/20/jsonpath-in-rest-assured/ и https://github.com/rest-assured/rest-assured/wiki/Usage#json-using-jsonpath.
