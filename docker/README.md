...
Важно: это будет скорее практическое задание, нежели домашняя работа, поэтому сдавать его не нужно! Если у вас возникнут вопросы, задавайте их в канале Slack.
