...
1. Предварительно скачайте Java Development Kit [по&nbsp;ссылке]([https://disk.360.yandex.ru/d/PUXGZKby3WfTlg](https://disk.360.yandex.ru/d/n_ZYEZam_9qG7A)). Выберите необходимую версию для используемой операционной системы.
